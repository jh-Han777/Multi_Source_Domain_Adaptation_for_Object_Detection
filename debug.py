...
def parse_args():
  ...
  """
    ...
    parser.add_argument(
        ...
        help="vgg16, res101",
        default="/media/hdd1/paper3/pretrained/vgg16_caffe.pth",
        type=str,
    )
    parser.add_argument(
        "--checkpoint_interval",
    ...
    # )
    parser.add_argument(
        "--cuda", dest="cuda", help="whether use CUDA", default=True
    )
    parser.add_argument(
        "--ls",
        dest="large_scale",
...
if __name__ == "__main__":
    ...
    for epoch in range(args.start_epoch, args.max_epochs + 1):
        ...
        for step in range(iters_per_epoch):
            ...
            ##
            out_d_pixel = out_d_pixel.unsqueeze(0)
            print("out_d_pixel",out_d_pixel,out_d_pixel.shape)
            print("domain_s",domain_s,domain_s.shape)
            dloss_s_p = 0.5 * FL(out_d_pixel,domain_s)
            ##
            ...
            print("domain_t",domain_t,domain_t.shape)
            print("out_d",out_d,out_d.shape)
            ...
            ##
            out_d_pixel = out_d_pixel.unsqueeze(0)
            dloss_t_p = 0.5 * FL(out_d_pixel, domain_t)
            ##
